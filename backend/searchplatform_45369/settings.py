"""
Django settings for searchplatform_45369 project.
...
ROOT_URLCONF = 'searchplatform_45369.urls'
...
WSGI_APPLICATION = 'searchplatform_45369.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "searchplatform_45369 API",
    "DESCRIPTION": "API documentation for searchplatform_45369 App",
    "VERSION": "v1",
}
